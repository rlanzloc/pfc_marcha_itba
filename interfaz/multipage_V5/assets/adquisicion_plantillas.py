...
try:
    arduino_derecha = serial.Serial('COM11', 115200, timeout=1)
...
df_derecha.to_csv('datos_derecha_sin_10.csv', index=False)
#df_izquierda.to_csv('datos_izquierda_sin_10.csv', index=False)
